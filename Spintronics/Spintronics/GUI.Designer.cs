...
namespace SpintronicsGUI
{
	partial class GUI
	{
		...
		private void InitializeComponent()
		{
			...
			title2.Name = "SensorData2";
			title2.Text = "Wheatstone F1 Phase";
			...
			this.chart3.Series.Add(series65);
			this.chart3.Series.Add(series66);
			this.chart3.Series.Add(series67);
			this.chart3.Series.Add(series68);
			this.chart3.Series.Add(series69);
			...
			this.chart3.Series.Add(series76);
			this.chart3.Series.Add(series77);
			this.chart3.Series.Add(series78);
			this.chart3.Series.Add(series79);
			this.chart3.Series.Add(series80);
			this.chart3.Series.Add(series81);
			this.chart3.Series.Add(series82);
			this.chart3.Series.Add(series83);
			this.chart3.Series.Add(series84);
			...
			title3.Name = "SensorData2";
			title3.Text = "Wheatstone F2 Amplitude";
