...
namespace SpintronicsGUI
{
	partial class GUI
	{
		...
		private void InitializeComponent()
		{
			...
			this.chart1.Size = new System.Drawing.Size(715, 414);
			...
			series150.Name = "30";
			this.chart2.Series.Add(series121);
			this.chart2.Series.Add(series122);
			this.chart2.Series.Add(series123);
			...
			this.chart2.Series.Add(series135);
			this.chart2.Series.Add(series136);
			this.chart2.Series.Add(series137);
			this.chart2.Series.Add(series138);
			this.chart2.Series.Add(series139);
			...
			this.chart2.Series.Add(series145);
			this.chart2.Series.Add(series146);
			this.chart2.Series.Add(series147);
			this.chart2.Series.Add(series148);
			this.chart2.Series.Add(series149);
			this.chart2.Series.Add(series150);
			this.chart2.Size = new System.Drawing.Size(715, 414);
			...
			series180.Name = "30";
			this.chart3.Series.Add(series151);
			this.chart3.Series.Add(series152);
			this.chart3.Series.Add(series153);
			this.chart3.Series.Add(series154);
			this.chart3.Series.Add(series155);
			this.chart3.Series.Add(series156);
			this.chart3.Series.Add(series157);
			this.chart3.Series.Add(series158);
			this.chart3.Series.Add(series159);
			this.chart3.Series.Add(series160);
			this.chart3.Series.Add(series161);
			this.chart3.Series.Add(series162);
			this.chart3.Series.Add(series163);
			this.chart3.Series.Add(series164);
			this.chart3.Series.Add(series165);
			this.chart3.Series.Add(series166);
			this.chart3.Series.Add(series167);
			this.chart3.Series.Add(series168);
			this.chart3.Series.Add(series169);
			this.chart3.Series.Add(series170);
			this.chart3.Series.Add(series171);
			this.chart3.Series.Add(series172);
			this.chart3.Series.Add(series173);
			this.chart3.Series.Add(series174);
			this.chart3.Series.Add(series175);
			this.chart3.Series.Add(series176);
			this.chart3.Series.Add(series177);
			this.chart3.Series.Add(series178);
			this.chart3.Series.Add(series179);
			this.chart3.Series.Add(series180);
			this.chart3.Size = new System.Drawing.Size(715, 414);
			...
			this.amplitudeTareButton.Click += new System.EventHandler(amplitudeTareButton_Click);
			// 
			// GUI
			// 
